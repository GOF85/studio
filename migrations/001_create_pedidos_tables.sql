-- ============================================================================
-- MIGRATION: Create tables for rental order management system (os_pedidos)
-- ============================================================================
-- Date: 2026-01-10
-- Replaces: os_material_orders (kept for reference/legacy data)
-- ============================================================================

-- ============================================================================
-- TABLE 1: os_pedidos_pendientes (Pending rental orders)
-- ============================================================================
-- Represents rental order requests waiting to be sent to provider
-- Each row = unique combination of (os_id, fecha_entrega, localización, solicita)
...
-- ============================================================================
-- Represents consolidated orders sent to provider
-- Can have multiple rows per event (one per fecha/localización combination)
-- Consolidates by (fecha, localización), ignoring solicita
...
-- Policy: Allow authenticated users full access (similar to os_material_orders)
