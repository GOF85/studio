...
import { IngredienteConERP } from '@/services/ingredientes-service';
...
interface IngredientesClientProps {
    initialData: {
        ingredientes: IngredienteConERP[];
        articulosERP: ArticuloERP[];
    };
}
...
export function IngredientesClient({ initialData }: IngredientesClientProps) {
    ...
    const [ingredientes, setIngredientes] = useState<IngredienteConERP[]>(initialData.ingredientes);
    const [articulosERP] = useState<ArticuloERP[]>(initialData.articulosERP);
