...
import { TipoServicio } from '@/services/tipo-servicio-service';

interface TipoServicioClientProps {
  initialData: TipoServicio[];
}

export function TipoServicioClient({ initialData }: TipoServicioClientProps) {
  const { data: items = initialData } = useTiposServicioBriefing();
