...
import { CosteFijoCPR } from '@/services/costes-fijos-cpr-service';

interface CostesFijosCprClientProps {
  initialData: CosteFijoCPR[];
}

export function CostesFijosCprClient({ initialData }: CostesFijosCprClientProps) {
    const { data } = useCostesFijosCPR();
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="rounded-[2rem] border-border/40 shadow-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Introduce los detalles del coste fijo mensual.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                id="importe"
                                type="number"
                                value={editingItem?.importeMensual || 0}
                    ...
                    <DialogFooter>
                        <Button variant="ghost" onClick={() => setIsDialogOpen(false)} className="rounded-full">
                            Cancelar
                        </Button>
                        <Button onClick={handleSave} disabled={upsertCoste.isPending} className="rounded-full px-8">
            ...
            <AlertDialog open={isConfirmDeleteDialogOpen} onOpenChange={setIsConfirmDeleteDialogOpen}>
                <AlertDialogContent className="rounded-[2rem] border-border/40 shadow-2xl">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Esta acción no se puede deshacer. Se eliminará permanentemente el coste fijo.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            <AlertDialog open={isBulkDeleteAlertOpen} onOpenChange={setIsBulkDeleteAlertOpen}>
                <AlertDialogContent className="rounded-[2rem] border-border/40 shadow-2xl">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Esta acción eliminará permanentemente los costes seleccionados. Esta operación no se puede deshacer.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel className="rounded-full">Cancelar</AlertDialogCancel>
