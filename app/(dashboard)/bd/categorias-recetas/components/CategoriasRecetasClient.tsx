...
import { CategoriaReceta } from '@/services/categorias-recetas-service';

const CSV_HEADERS = ["id", "nombre", "snack"];

interface CategoriasRecetasClientProps {
  initialData: CategoriaReceta[];
}

export function CategoriasRecetasClient({ initialData }: CategoriasRecetasClientProps) {
