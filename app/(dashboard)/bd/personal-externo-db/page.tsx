...
import { MoreHorizontal, Pencil, Trash2, FileUp, FileDown, UserPlus, Search, Trash, Check, X } from 'lucide-react';
...
import { usePersonalExternoDB, useDeletePersonalExternoDB, useProveedores, useUpsertPersonalExternoDB, useDeletePersonalExternoBulk } from '@/hooks/use-data-queries';
...
export default function PersonalExternoPage() {
  ...
  const { data: items = [], isLoading: isLoadingItems } = usePersonalExternoDB();
  ...
  if (isLoadingItems || isLoadingProveedores) {
