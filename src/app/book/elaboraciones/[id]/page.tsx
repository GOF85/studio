...
import { Loader2, Save, X, Component, Trash2 } from 'lucide-react';
...
export default function ElaboracionFormPage() {
    ...
    useEffect(() => {
        ...
        } else { // This is for a new elaboration (/nuevo)
            elabToLoad = { 
    ...
    const onSubmit = (data: ElaborationFormValues, costePorUnidad: number) => {
        setIsLoading(true);
