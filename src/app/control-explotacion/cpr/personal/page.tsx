...
export default function DetallePersonalCprPage() {
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {filteredDetails.length > 0 ? filteredDetails.map((detalle) => (
                                ...
                                <TableRow><TableCell colSpan={7} className="text-center h-24">No se encontraron datos para este periodo.</TableCell></TableRow>
                            )}
                        </TableBody>
                    </Table>
                </CardContent>
