    ...
    return (
        <>
            ...
            <section id="c4">
                ...
                <p>El operario de logística, desde la "Orden de Picking" de un evento, verá los "kits de receta" a preparar. Recogerá las elaboraciones (ya con su etiqueta de lote) y las asignará a contenedores isotérmicos, indicando qué kit va en qué contenedor.</p>
