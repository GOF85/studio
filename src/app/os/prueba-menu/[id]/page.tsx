...
const handlePrint = async () => {
    ...
    try {
        ...
        // --- TEXTOS ---
        const texts = {
            es: { proposalTitle: 'Prueba de Menú', client: 'Cliente:', item: 'Producto', qty: 'Cantidad', receivedBy: 'Recibido por:', signatureDate: 'Fecha y hora:', signature: 'Firma:', footer: 'MICE Catering - Albarán de Entrega' },
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="no-print flex items-center gap-6 p-4 border rounded-lg bg-background">
             <div className="flex items-center gap-2">
                <FormLabel className="font-bold">Asistentes a la prueba</FormLabel>
                <Input value={asistentesPrueba} readOnly className="h-10 w-20 text-center font-bold text-lg"/>
            </div>
             <div className="flex items-center gap-2">
                <FormLabel className="font-bold flex items-center gap-2">Coste de la prueba de menú</FormLabel>
                <FormField
                    control={control}
