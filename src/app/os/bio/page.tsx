  ...
  return (
    <>
      <div className="flex items-center justify-between mb-4">
       ...
       <Card>
        <CardHeader><CardTitle>Gestión de Pedidos de Bio</CardTitle></CardHeader>
        <CardContent>
                ...
                <Table>
                    ...
                    <TableBody>
                        {materialOrders.length > 0 ? materialOrders.map(order => (
                            ...
                            <TableRow><TableCell colSpan={5} className="h-20 text-center text-muted-foreground">No hay pedidos de bio para este servicio.</TableCell></TableRow>
                        )}
                    </TableBody>
                </Table>
            </div>
